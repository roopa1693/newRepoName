...
public class CreateContactWithAdminSelectTest extends BaseClass {
	
	@Test
	public void createContactWithAdminSelectTest() throws Throwable

	{
		...
		String adminSelect=eLib.getExcelCellValue("DropDownOptions", 5, 2);
		
		//generate random number..
		int ranNum = jLib.generateRandomNumber();
		
		
		//mouse action for click on contacts..
		HomePage hPage=new HomePage(driver);
		hPage.getContactLink().click();
		
		//code for create new contact..
		...
		newContact.selectAdmin(adminSelect);
		newContact.clickonSaveBtn();
		
		//verifying contact created or not..
